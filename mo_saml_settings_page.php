				...
				<table border="1" style="background-color:#FFFFFF; border:1px solid #CCCCCC; padding:0px 0px 0px 10px; margin:2px; border-collapse: collapse; width:98%">
					...
					<tr>
						...
						<tr>
							...
							<td style="width:60%;  padding: 15px;">Available in the <a href="<?php echo admin_url('admin.php?page=mo_iwa_settings&tab=licensing');?>"><b>premium</b></a> version</td>
						</tr>
				</table>
					<p style="text-align: center;font-size: 13pt;font-weight: bold;">OR</p>
					<p>Provide this metadata URL to your Identity Provider:</p>
					<code>Metadata URL is available in the <a href="<?php echo admin_url('admin.php?page=mo_iwa_settings&tab=licensing');?>"><b>Premium</b></a> version of the plugin.</code>
			  </tr>					
				</td>
				</tr>
	...
	<div class="mo_saml_table_layout">
		...
		<span style="float:right;margin-right:15px;"><input type="button" name="ok_btn" class="button button-primary button-large" value="OK, Got It" onclick="window.location.href='admin.php?page=mo_iwa_settings'" /></span>
			...
			<tr style="vertical-align:top;">
				...
				<p class="mo_saml_local_pricing_text" style="padding-bottom:295px;">Unlimited Windows Authentications via AD FS,<br>
				Basic Role Mapping,<br>
				Basic Attribute Mapping,<br>
				Widget to add AD FS Login Link on your site<br>
				</p>
				<hr>
				...
				<h4 class="mo_saml_local_pricing_sub_header" style="padding-bottom:8px !important;"><a class="button button-primary button-large"
				 onclick="upgradeform('wp_iwa_sso_basic_plan')" >Click here to upgrade</a> *</h4>
				
				<hr>
				<p class="mo_saml_local_pricing_text" style="padding:10px;">$449 - One Time Payment</p>
				
				<hr>
				<p class="mo_saml_local_pricing_text" style="padding-bottom:64px !important;">
					Unlimited Windows Authentications via AD FS,<br>
					Customized Role Mapping,<br>
					Customized Attribute Mapping,<br>
					Widget, Shortcode to add IDP Login Link on your site,<br>
					Auto-Redirect to AD FS,<br>
					Step-by-step guide to setup AD FS,<br>
				...
				<h3 class="mo_saml_local_pricing_header">Custom AD Server</h3>
				<p></p>
				<h4 class="mo_saml_local_pricing_sub_header" style="padding-bottom:8px !important;"><a class="button button-primary button-large"
				 onclick="upgradeform('wp_iwa_sso_custom_server_plan')" >Click here to upgrade</a> *</h4>
				
				<hr>
				<p class="mo_saml_local_pricing_text" style="padding:10px;">$649 - One Time Payment</p>
				
				<hr>
				<p class="mo_saml_local_pricing_text" style="padding-bottom:64px !important;">
					Custom AD Server,<br>
					Unlimited Windows Authentications via AD Server,<br>
					Customized Role Mapping,<br>
					Customized Attribute Mapping,<br>
					Widget, Shortcode to add AD Server Login Link on your site,<br>
					Auto-Redirect to AD Server,<br>
					Step-by-step guide to configure AD Server,<br>
					Support for sites behind reverse-proxy,<br>
					Protect your complete site,<br>
					Options to select SAML Request binding type,<br>
					<br><br>
				...
				<p></p>
				<h4 class="mo_saml_local_pricing_sub_header" style="padding-bottom:8px !important;"><a class="button button-primary button-large"
				 onclick="upgradeform('wp_iwa_sso_premium_plan')" >Click here to upgrade</a> *</h4>
				 
				<hr>
				<p class="mo_saml_local_pricing_text">$649 + One Time Setup Fees <br>
				( $60 per hour )</p>
				<hr>
				...
				<p class="mo_saml_local_pricing_text">
					...
					Protect your complete site,<br>
					Options to select SAML Request binding type,<br>
					End to End AD Server Configuration**<br><br><br><br>
				</p>
		...
		<form style="display:none;" id="loginform" action="<?php echo get_option( 'mo_iwa_host_name').'/moas/login'; ?>" 
		target="_blank" method="post">
		<input type="email" name="username" value="<?php echo get_option('mo_iwa_admin_email'); ?>" />
		<input type="text" name="redirectUrl" value="<?php echo get_option( 'mo_iwa_host_name').'/moas/initializepayment'; ?>" />
		...
		At miniOrange, we want to ensure you are 100% happy with your purchase. If you feel that the premium plugin you purchased is not the best fit for your requirements or you’ve attempted to resolve any feature issues with our support team, which couldn't get resolved. We will refund the whole amount within 10 days of the purchase.
